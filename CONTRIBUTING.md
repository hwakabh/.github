...
## Bug Reports
For bug reports or requests [submit an issue](https://github.com/hwakabh/.github/issues).
...
## Pull Requests
The preferred way to contribute is to fork the [main repository](https://github.com/hwakabh/.github) on GitHub.
...
1. Fork the [main repository](https://github.com/hwakabh/.github).  Click on the 'Fork' button near the top of the page.  This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:
```shell
$ git clone git@github.com:${YOUR_USERNAME}/.github.git
$ cd .github
```
...
6. Finally, go to the web page of your fork of the `.github` repo and click 'Pull Request' to send your changes for review.
